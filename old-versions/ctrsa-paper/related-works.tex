...
\begin{table}[tbhp]
%\small
\caption{A summary of the current state-of-the-art of hardware designs of NIST post-quantum candidates, implemented on FPGA. Results taken from \url{pqczoo.com}.}\label{tab:pqc}
%\vspace{-0.2cm}
\begin{center}
...
\label{tab:params}
\begin{center}
\begin{tabular}{l c c c c c c c c x{2cm}}% y{.75cm} y{.75cm} y{.75cm} y{2.25cm} y{.75cm} y{.75cm} y{.75cm} y{2.75cm}}
\hline \Tstrut
%&  \textsf{FrodoKEM-640}
%&  \textsf{FrodoKEM-976} 
%& $n$
